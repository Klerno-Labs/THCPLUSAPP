...
const INPUT = "/tmp/bud-raw.png";
const OUTPUT = path.resolve("public/products/Platinum-Mac-hero.png");

// Pixels where R, G, B are all BELOW this value are considered black background
...
async function main() {
  ...
  // Pass 1: Set alpha to 0 for dark/black background pixels
